...
public class AuthService {
    ...
    public ApiResponse signUp (SignUpRequest request){
        ...
        if (userRepository.existsByEmail(request.getEmail())){
            return new ApiResponse(false, "Email is already registred . Please sign using a different Email");// making my password hash encoded 
        }
   ...
   return new ApiResponse(true , "Account created successfully ! Welcome", user.getFirstName() +""+ user.getSecondName());
